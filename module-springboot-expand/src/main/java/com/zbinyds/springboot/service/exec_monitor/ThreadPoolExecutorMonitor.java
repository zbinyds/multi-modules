...
public class ThreadPoolExecutorMonitor extends ThreadPoolExecutor {
    ...
    private static final ThreadLocal<Long> EXECUTE_TIMER_MONITOR = new InheritableThreadLocal<>();
    private final String poolName;

    public ThreadPoolExecutorMonitor(int corePoolSize, int maximumPoolSize, long keepAliveTime, @NonNull TimeUnit unit,
                                     @NonNull BlockingQueue<Runnable> workQueue, @NonNull ThreadFactoryMonitor threadFactory,
